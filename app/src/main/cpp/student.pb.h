...
const std::string& Student_PhoneType_Name(Student_PhoneType value);
template<typename T>
inline const std::string& Student_PhoneType_Name(T enum_t_value) {
  ...
  return Student_PhoneType_Name(static_cast<Student_PhoneType>(enum_t_value));
}
...
class Student_PhoneNumber :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:tutorial.Student.PhoneNumber) */ {
 public:
  Student_PhoneNumber();
...
class Student :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:tutorial.Student) */ {
 public:
  Student();
  virtual ~Student();
